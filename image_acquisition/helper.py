...
def image_process_fn(image, metadata: dict): 
    ...
    '''This is the mentioned image processing function. As I said, micromanager takes this custom function as an argument and uses it.
        Except when I actually try to change the copied array, micromanager thinks this function is suddenly an invalid argument'''
